...
| User database check         | Unit test        | 1. login 2. press close button 3. press file button                                                    | All passwords need to be encrypted with hash and id has to be unique between 1 to 99,999.                                                                                                                                                                                                                                                                                                                                                           |
